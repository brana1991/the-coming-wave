const reviews = [
  ...
  },
  {
    ...
    occupation:
      "Dobitnik Nobelove nagrade i autor bestselera Misliti brzo i sporo",
  },
  {
...
function createReviewCard(review) {
  return `
    <div class="review-card">
        ...
        <p class="review-authorSrb">${review.authorSrb}<span class="review-authorOg">${review.authorOg}</span></p>
